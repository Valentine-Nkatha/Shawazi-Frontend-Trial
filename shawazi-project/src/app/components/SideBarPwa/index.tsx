...
//                 <Image
//                     src="/images/shawazilogo.png" // Update the src as needed
//                     alt="Shawazi Logo"
//                     className="w-20 md:w-16 lg:w-14 xl:w-20 mx-auto mb-4 mt-12"
//                     width={80} // Set a width for the Image component
//                     height={80} // Set a height for the Image component
//                     priority // Optional: for important images to load quickly
//                 />
//             </div>
...
interface SideBarProps {
  userRole: string; // Assuming userRole can be 'buyer', 'seller', etc.
}
...
const SideBar: React.FC<SideBarProps> = ({ userRole }) => {
    ...
    // Optionally add more items based on userRole
    if (userRole === 'seller') {
