...
const ContractDrafting: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-white p-4 md:pl-10 md:p-8 lg:pl-2 lg:p-1 ml">
    <div className="flex-1 flex items-center justify-center">
      ...
      <div className="flex-1 flex flex-col justify-center mt-6 md:mt-0">
        ...
        <Link href="/components/Agreements">
          <button 
            className="bg-green-500 text-white py-2 px-8 md:py-3 md:px-32 rounded hover:bg-opacity-90 transition duration-300"
          >
