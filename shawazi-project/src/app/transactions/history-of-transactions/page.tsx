...
//   return (
//     <Transactionss userRole={userRole} />
//   );
// };
...
interface TransactionssProps {
  userRole: 'buyer' | 'seller'; // Define possible user roles
}

const Transactionss: React.FC<TransactionssProps> = ({ userRole }) => {
  const { transactions, isLoading, error } = useTransactions();
  const [filterStatus, setFilterStatus] = useState("");
...
const Page = () => {
  const userRole: 'buyer' | 'seller' = "buyer"; // Specify the userRole type
